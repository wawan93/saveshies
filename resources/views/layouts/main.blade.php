...
<div class="page__layout">
    ...
    <header class="header">
        <div class="header__inner">
            ...
            <a class="button header__button" href="#0" data-modal=".modal--donate">Поддержать
                фонд</a>
...
<footer class="footer">
    <div class="footer__inner inner">
        <div class="footer__main">
            ...
            <address class="footer__writeUs">По всем вопросам обращайтесь на <a
                    href="mailto:save-shyes@gmail.com">save-shyes@gmail.com</a>
            </address>
        </div>
...
<div class="modal modal--donate">
    ...
    <div class="modal__inner">
        <div class="modal__content cntWrp">
            ...
            <div class="modal__body">Здравствуйте. Оформив ежемесячное пожертвование, вы помогаете
                активистам
                «SaveШиес!» в борьбе против незаконного строительства мусорного полигона, а также
                восстановлении леса и
                др. Вы можете узнать больше в разделе <a href="about.html" target="_blank">о
                    фонде</a>
            </div>
            <div class="modal__form">
                ...
                <form class="form form--donate" method="POST" action="{{ route('donate') }}">
                    ...
                    <fieldset class="form__item form__item--type">
                        ...
                        <div class="form__row form__row--radio">
                            <label class="form__radio">
                                <input type="radio" name="donate-type" value="monthly" required
                                       checked><span
                        ...
                        <div class="form__tip">*Ежемесячное пожертвование раз в месяц списывается с
                            банковской карты,
                            Яндекс кошелька или Крипто кошелька. Вы в любой момент сможете отключить
                            его.
                        </div>
                    </fieldset>
                        ...
                        <fieldset class="form__item">
                            ...
                            <div class="form__amountWrp">
                                <label class="form__amount form__amount--chbx">
                                    <input type="radio" name="amount-fix" value="1000">
                                    <span class="form__amountText">1000</span>
                                </label>
                                <label class="form__amount form__amount--chbx">
                                    <input type="radio" name="amount-fix" value="2000" checked>
                                    <span class="form__amountText">2000</span>
                                </label>
                                <label class="form__amount form__amount--chbx">
                                    <input type="radio" name="amount-fix" value="3000">
                                    <span class="form__amountText">3000</span>
                                </label>
                                <label class="form__amount form__amount--input">
                                    <input class="form__field" type="text" name="amount"
                    ...
                    <div class="form__row">
                        ...
                        <div class="form__item">
                            <input class="form__field" type="text" name="surname" required
                                   placeholder="Фамилия"/>
                        </div>
                    </div>
...
{{--                            </label>--}}
                    ...
                    <label class="form__item form__item--checkbox">
                        <input type="checkbox" name="offer-agree" required><span
                            class="form__label">Соглашаюсь с <a
...
<div class="modal modal--selectVolunteer">
    ...
    <div class="modal__inner">
        <div class="modal__content cntWrp">
            ...
            <div class="modal__body">Оформив ежемесячное пожертвование вы помогаете активистам
                «SaveШиес!» в борьбе против незаконного строительства мусорного.
            </div>
